...
- 해결방법
  ...
  - Stop and Wait : 매번 전송한 패킷에 대해 확인 응답을 받아야만 그 다음 패킷을 전송하는 방법
    - ACK 를 받고나서 다음 프레임을 전송하므로 비효율 적임 -> 슬라이딩 윈도우가 훨신 효율 적이다.
  ...
  - 동작방식 : 먼저 윈도우에 포함되는 모든 패킷을 전송하고, 그 패킷들의 전달이 확인되는대로 이 윈도우를 옆으로 옮김으로써 그 다음 패킷들을 전송
    ...
    - ![스크린샷 2023-09-02 오후 2 31 36](https://github.com/wjddudqls96/blockChain/assets/59672589/552d3b95-e791-47be-bae4-c1775b8f65dd)
